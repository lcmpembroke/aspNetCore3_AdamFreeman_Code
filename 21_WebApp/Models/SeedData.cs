...
namespace WebApp.Models
{
    public static class SeedData
    {
        ...
        {
            // ensures all pending migrations have been applied to database
            context.Database.Migrate();

            if (context.Products.Count() == 0 && context.Suppliers.Count() == 0 && context.Categories.Count() == 0)
            {
                // seeds database if empty.
                // EFCore takes care of mapping the objects into the tables, and ley properties assigned automatically when data stored
                ...
                context.Products.AddRange( 
                    ...
                    new Product { Name = "Lifejacket", Price = 49.85m, Category = c1, Supplier = s1 },
